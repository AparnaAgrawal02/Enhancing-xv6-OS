...
main(void)
{
  ...
  24:	318080e7          	jalr	792(ra) # 338 <sleep>
...
gets(char *buf, int max)
{
 ...
 11c:	1a8080e7          	jalr	424(ra) # 2c0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 16e:	17e080e7          	jalr	382(ra) # 2e8 <open>
  if(fd < 0)
 ...
 17e:	186080e7          	jalr	390(ra) # 300 <fstat>
 182:	892a                	mv	s2,a0
  close(fd);
 184:	8526                	mv	a0,s1
 186:	00000097          	auipc	ra,0x0
 18a:	14a080e7          	jalr	330(ra) # 2d0 <close>
  return r;
}
 18e:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 7c6:	b6e080e7          	jalr	-1170(ra) # 330 <sbrk>
  if(p == (char*)-1)
