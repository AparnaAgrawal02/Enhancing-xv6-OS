...
000000000000011a <grep>:
{
 ...
 164:	3ec080e7          	jalr	1004(ra) # 54c <write>
      p = q+1;
 ...
 1a2:	3a6080e7          	jalr	934(ra) # 544 <read>
...
00000000000001ee <main>:
{
 ...
 22e:	342080e7          	jalr	834(ra) # 56c <open>
 232:	84aa                	mv	s1,a0
 ...
 24a:	30e080e7          	jalr	782(ra) # 554 <close>
  for(i = 2; i < argc; i++){
...
gets(char *buf, int max)
{
 ...
 3a0:	1a8080e7          	jalr	424(ra) # 544 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3f2:	17e080e7          	jalr	382(ra) # 56c <open>
  if(fd < 0)
 ...
 402:	186080e7          	jalr	390(ra) # 584 <fstat>
 406:	892a                	mv	s2,a0
  close(fd);
 408:	8526                	mv	a0,s1
 40a:	00000097          	auipc	ra,0x0
 40e:	14a080e7          	jalr	330(ra) # 554 <close>
  return r;
}
 412:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 a4a:	b6e080e7          	jalr	-1170(ra) # 5b4 <sbrk>
  if(p == (char*)-1)
