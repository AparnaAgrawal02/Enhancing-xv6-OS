...
wc(int fd, char *name)
{
  ...
  86:	3aa080e7          	jalr	938(ra) # 42c <read>
...
main(int argc, char *argv[])
{
 ...
 130:	328080e7          	jalr	808(ra) # 454 <open>
 134:	892a                	mv	s2,a0
 ...
 14a:	2f6080e7          	jalr	758(ra) # 43c <close>
  for(i = 1; i < argc; i++){
...
gets(char *buf, int max)
{
 ...
 288:	1a8080e7          	jalr	424(ra) # 42c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2da:	17e080e7          	jalr	382(ra) # 454 <open>
  if(fd < 0)
 ...
 2ea:	186080e7          	jalr	390(ra) # 46c <fstat>
 2ee:	892a                	mv	s2,a0
  close(fd);
 2f0:	8526                	mv	a0,s1
 2f2:	00000097          	auipc	ra,0x0
 2f6:	14a080e7          	jalr	330(ra) # 43c <close>
  return r;
}
 2fa:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 4da:	f5e080e7          	jalr	-162(ra) # 434 <write>
}
...
malloc(uint nbytes)
{
 ...
 932:	b6e080e7          	jalr	-1170(ra) # 49c <sbrk>
  if(p == (char*)-1)
