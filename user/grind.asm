...
go(int which_child)
{
  ...
  char *break0 = sbrk(0);
      ...
      94:	e66080e7          	jalr	-410(ra) # ef6 <sbrk>
      98:	8aaa                	mv	s5,a0
  uint64 iters = 0;
  ...
  mkdir("grindir");
      ...
      a6:	e34080e7          	jalr	-460(ra) # ed6 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2ee50513          	addi	a0,a0,750 # 1398 <malloc+0xe4>
      b2:	00001097          	auipc	ra,0x1
      b6:	e2c080e7          	jalr	-468(ra) # ede <chdir>
  ...
  chdir("/");
      ...
      e2:	e00080e7          	jalr	-512(ra) # ede <chdir>
  ...
  int fd = -1;
     ...
     100:	5b4a0a13          	addi	s4,s4,1460 # 16b0 <buf.1246>
     ...
     116:	d9c080e7          	jalr	-612(ra) # eae <open>
     11a:	00001097          	auipc	ra,0x1
     11e:	d7c080e7          	jalr	-644(ra) # e96 <close>
    iters++;
    ...
    if((iters % 500) == 0)
     ...
     138:	d5a080e7          	jalr	-678(ra) # e8e <write>
    int what = rand() % 23;
    ...
    if(what == 1){
     ...
     1d6:	cac080e7          	jalr	-852(ra) # e7e <pipe>
     ...
     1e6:	c9c080e7          	jalr	-868(ra) # e7e <pipe>
     ...
     216:	c84080e7          	jalr	-892(ra) # e96 <close>
      close(aa[1]);
     21a:	f9c42503          	lw	a0,-100(s0)
     21e:	00001097          	auipc	ra,0x1
     222:	c78080e7          	jalr	-904(ra) # e96 <close>
      close(bb[1]);
     226:	fa442503          	lw	a0,-92(s0)
     22a:	00001097          	auipc	ra,0x1
     22e:	c6c080e7          	jalr	-916(ra) # e96 <close>
      char buf[4] = { 0, 0, 0, 0 };
     ...
     3aa:	ae8080e7          	jalr	-1304(ra) # e8e <write>
     ...
     48c:	a46080e7          	jalr	-1466(ra) # ece <link>
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1246+0xcb>
     522:	00001097          	auipc	ra,0x1
     526:	9d4080e7          	jalr	-1580(ra) # ef6 <sbrk>
     52a:	bee5                	j	122 <go+0xaa>
      if(sbrk(0) > break0)
     52c:	4501                	li	a0,0
     52e:	00001097          	auipc	ra,0x1
     532:	9c8080e7          	jalr	-1592(ra) # ef6 <sbrk>
     536:	beaaf6e3          	bgeu	s5,a0,122 <go+0xaa>
        sbrk(-(sbrk(0) - break0));
     53a:	4501                	li	a0,0
     53c:	00001097          	auipc	ra,0x1
     540:	9ba080e7          	jalr	-1606(ra) # ef6 <sbrk>
     544:	40aa853b          	subw	a0,s5,a0
     548:	00001097          	auipc	ra,0x1
     54c:	9ae080e7          	jalr	-1618(ra) # ef6 <sbrk>
     ...
     56e:	974080e7          	jalr	-1676(ra) # ede <chdir>
     572:	ed21                	bnez	a0,5ca <go+0x552>
      kill(pid);
     574:	855a                	mv	a0,s6
     576:	00001097          	auipc	ra,0x1
     57a:	928080e7          	jalr	-1752(ra) # e9e <kill>
      wait(0);
     57e:	4501                	li	a0,0
     ...
     59a:	918080e7          	jalr	-1768(ra) # eae <open>
     59e:	00001097          	auipc	ra,0x1
     5a2:	8f8080e7          	jalr	-1800(ra) # e96 <close>
        exit(0);
     5a6:	4501                	li	a0,0
     ...
     602:	8f0080e7          	jalr	-1808(ra) # eee <getpid>
     606:	00001097          	auipc	ra,0x1
     60a:	898080e7          	jalr	-1896(ra) # e9e <kill>
        exit(0);
     60e:	4501                	li	a0,0
     ...
     63a:	848080e7          	jalr	-1976(ra) # e7e <pipe>
     ...
     658:	842080e7          	jalr	-1982(ra) # e96 <close>
      close(fds[1]);
     65c:	fac42503          	lw	a0,-84(s0)
     660:	00001097          	auipc	ra,0x1
     664:	836080e7          	jalr	-1994(ra) # e96 <close>
      wait(0);
     668:	4501                	li	a0,0
     ...
     6b0:	7e2080e7          	jalr	2018(ra) # e8e <write>
     6b4:	4785                	li	a5,1
     ...
     6c8:	7c2080e7          	jalr	1986(ra) # e86 <read>
     6cc:	4785                	li	a5,1
     ...
     7f4:	69e080e7          	jalr	1694(ra) # e8e <write>
     7f8:	4785                	li	a5,1
     ...
     808:	6c2080e7          	jalr	1730(ra) # ec6 <fstat>
     ...
     904:	596080e7          	jalr	1430(ra) # e96 <close>
        close(bb[1]);
     908:	fa442503          	lw	a0,-92(s0)
     90c:	00000097          	auipc	ra,0x0
     910:	58a080e7          	jalr	1418(ra) # e96 <close>
        close(aa[0]);
     914:	f9842503          	lw	a0,-104(s0)
     918:	00000097          	auipc	ra,0x0
     91c:	57e080e7          	jalr	1406(ra) # e96 <close>
        close(1);
     920:	4505                	li	a0,1
     922:	00000097          	auipc	ra,0x0
     926:	574080e7          	jalr	1396(ra) # e96 <close>
        if(dup(aa[1]) != 1){
     92a:	f9c42503          	lw	a0,-100(s0)
     92e:	00000097          	auipc	ra,0x0
     932:	5b8080e7          	jalr	1464(ra) # ee6 <dup>
     936:	4785                	li	a5,1
     ...
     960:	53a080e7          	jalr	1338(ra) # e96 <close>
        char *args[3] = { "echo", "hi", 0 };
     ...
     990:	51a080e7          	jalr	1306(ra) # ea6 <exec>
        fprintf(2, "grind: echo: not found\n");
     ...
     9d4:	4c6080e7          	jalr	1222(ra) # e96 <close>
        close(bb[0]);
     9d8:	fa042503          	lw	a0,-96(s0)
     9dc:	00000097          	auipc	ra,0x0
     9e0:	4ba080e7          	jalr	1210(ra) # e96 <close>
        close(0);
     9e4:	4501                	li	a0,0
     9e6:	00000097          	auipc	ra,0x0
     9ea:	4b0080e7          	jalr	1200(ra) # e96 <close>
        if(dup(aa[0]) != 0){
     9ee:	f9842503          	lw	a0,-104(s0)
     9f2:	00000097          	auipc	ra,0x0
     9f6:	4f4080e7          	jalr	1268(ra) # ee6 <dup>
     ...
     a20:	47a080e7          	jalr	1146(ra) # e96 <close>
        close(1);
     a24:	4505                	li	a0,1
     a26:	00000097          	auipc	ra,0x0
     a2a:	470080e7          	jalr	1136(ra) # e96 <close>
        if(dup(bb[1]) != 1){
     a2e:	fa442503          	lw	a0,-92(s0)
     a32:	00000097          	auipc	ra,0x0
     a36:	4b4080e7          	jalr	1204(ra) # ee6 <dup>
     a3a:	4785                	li	a5,1
     ...
     a64:	436080e7          	jalr	1078(ra) # e96 <close>
        char *args[2] = { "cat", 0 };
     ...
     a88:	422080e7          	jalr	1058(ra) # ea6 <exec>
        fprintf(2, "grind: cat: not found\n");
...
iter()
{
  ...
  exit(0);
    ...
    kill(pid1);
     ...
     baa:	2f8080e7          	jalr	760(ra) # e9e <kill>
    kill(pid2);
     bae:	854a                	mv	a0,s2
     bb0:	00000097          	auipc	ra,0x0
     bb4:	2ee080e7          	jalr	750(ra) # e9e <kill>
...
main()
{
  ...
  while(1){
    ...
    sleep(20);
     ...
     bd2:	330080e7          	jalr	816(ra) # efe <sleep>
    int pid = fork();
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     ce2:	1a8080e7          	jalr	424(ra) # e86 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d34:	17e080e7          	jalr	382(ra) # eae <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d44:	186080e7          	jalr	390(ra) # ec6 <fstat>
     d48:	892a                	mv	s2,a0
  close(fd);
     d4a:	8526                	mv	a0,s1
     d4c:	00000097          	auipc	ra,0x0
     d50:	14a080e7          	jalr	330(ra) # e96 <close>
  return r;
}
     d54:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f34:	f5e080e7          	jalr	-162(ra) # e8e <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    138c:	b6e080e7          	jalr	-1170(ra) # ef6 <sbrk>
  if(p == (char*)-1)
