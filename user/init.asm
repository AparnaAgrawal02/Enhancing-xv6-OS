...
main(void)
{
  ...
  1a:	3a0080e7          	jalr	928(ra) # 3b6 <open>
  ...
  28:	3ca080e7          	jalr	970(ra) # 3ee <dup>
  dup(0);  // stderr
  2c:	4501                	li	a0,0
  2e:	00000097          	auipc	ra,0x0
  32:	3c0080e7          	jalr	960(ra) # 3ee <dup>
  ...
  94:	32e080e7          	jalr	814(ra) # 3be <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	80650513          	addi	a0,a0,-2042 # 8a0 <malloc+0xe4>
  a2:	00000097          	auipc	ra,0x0
  a6:	314080e7          	jalr	788(ra) # 3b6 <open>
  ...
  da:	2d8080e7          	jalr	728(ra) # 3ae <exec>
...
gets(char *buf, int max)
{
 ...
 1ea:	1a8080e7          	jalr	424(ra) # 38e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 23c:	17e080e7          	jalr	382(ra) # 3b6 <open>
  if(fd < 0)
 ...
 24c:	186080e7          	jalr	390(ra) # 3ce <fstat>
 250:	892a                	mv	s2,a0
  close(fd);
 252:	8526                	mv	a0,s1
 254:	00000097          	auipc	ra,0x0
 258:	14a080e7          	jalr	330(ra) # 39e <close>
  return r;
}
 25c:	854a                	mv	a0,s2
