...
main(int argc, char *argv[])
{
  ...
  4c:	2da080e7          	jalr	730(ra) # 322 <write>
    if(i + 1 < argc){
  ...
  60:	2c6080e7          	jalr	710(ra) # 322 <write>
  for(i = 1; i < argc; i++){
  ...
  76:	2b0080e7          	jalr	688(ra) # 322 <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
...
gets(char *buf, int max)
{
 ...
 176:	1a8080e7          	jalr	424(ra) # 31a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1d8:	186080e7          	jalr	390(ra) # 35a <fstat>
 1dc:	892a                	mv	s2,a0
  close(fd);
 1de:	8526                	mv	a0,s1
 1e0:	00000097          	auipc	ra,0x0
 1e4:	14a080e7          	jalr	330(ra) # 32a <close>
  return r;
}
 1e8:	854a                	mv	a0,s2
