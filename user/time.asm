...
main(int argc, char ** argv) 
{
  ...
  2e:	33a080e7          	jalr	826(ra) # 364 <exec>
      printf("exec(): failed\n");
  ...
  6c:	354080e7          	jalr	852(ra) # 3bc <sleep>
      exit(0);
  70:	4501                	li	a0,0
  ...
  88:	2b0080e7          	jalr	688(ra) # 334 <waitx>
    printf("\nwaiting:%d\nrunning:%d\n", wtime, rtime);
...
gets(char *buf, int max)
{
 ...
 1a0:	1a8080e7          	jalr	424(ra) # 344 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1f2:	17e080e7          	jalr	382(ra) # 36c <open>
  if(fd < 0)
 ...
 202:	186080e7          	jalr	390(ra) # 384 <fstat>
 206:	892a                	mv	s2,a0
  close(fd);
 208:	8526                	mv	a0,s1
 20a:	00000097          	auipc	ra,0x0
 20e:	14a080e7          	jalr	330(ra) # 354 <close>
  return r;
}
 212:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 84a:	b6e080e7          	jalr	-1170(ra) # 3b4 <sbrk>
  if(p == (char*)-1)
