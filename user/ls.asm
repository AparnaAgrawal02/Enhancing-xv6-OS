...
fmtname(char *path)
{
  ...
  6a:	ab298993          	addi	s3,s3,-1358 # b18 <buf.1116>
...
ls(char *path)
{
  ...
  de:	4b8080e7          	jalr	1208(ra) # 592 <open>
  ...
  f0:	4be080e7          	jalr	1214(ra) # 5aa <fstat>
 ...
 13a:	444080e7          	jalr	1092(ra) # 57a <close>
}
 ...
 190:	3ee080e7          	jalr	1006(ra) # 57a <close>
    return;
 ...
 21c:	352080e7          	jalr	850(ra) # 56a <read>
 220:	47c1                	li	a5,16
...
gets(char *buf, int max)
{
 ...
 3c6:	1a8080e7          	jalr	424(ra) # 56a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 428:	186080e7          	jalr	390(ra) # 5aa <fstat>
 42c:	892a                	mv	s2,a0
  close(fd);
 42e:	8526                	mv	a0,s1
 430:	00000097          	auipc	ra,0x0
 434:	14a080e7          	jalr	330(ra) # 57a <close>
  return r;
}
 438:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 a70:	b6e080e7          	jalr	-1170(ra) # 5da <sbrk>
  if(p == (char*)-1)
