...
main(int argc, char *argv[])
{
  ...
  36:	30c080e7          	jalr	780(ra) # 33e <link>
...
gets(char *buf, int max)
{
 ...
 152:	1a8080e7          	jalr	424(ra) # 2f6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a4:	17e080e7          	jalr	382(ra) # 31e <open>
  if(fd < 0)
 ...
 1b4:	186080e7          	jalr	390(ra) # 336 <fstat>
 1b8:	892a                	mv	s2,a0
  close(fd);
 1ba:	8526                	mv	a0,s1
 1bc:	00000097          	auipc	ra,0x0
 1c0:	14a080e7          	jalr	330(ra) # 306 <close>
  return r;
}
 1c4:	854a                	mv	a0,s2
