...
main(int argc, char *argv[])
{
  ...
  2e:	31c080e7          	jalr	796(ra) # 346 <unlink>
...
gets(char *buf, int max)
{
 ...
 16a:	1a8080e7          	jalr	424(ra) # 30e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1bc:	17e080e7          	jalr	382(ra) # 336 <open>
  if(fd < 0)
 ...
 1cc:	186080e7          	jalr	390(ra) # 34e <fstat>
 1d0:	892a                	mv	s2,a0
  close(fd);
 1d2:	8526                	mv	a0,s1
 1d4:	00000097          	auipc	ra,0x0
 1d8:	14a080e7          	jalr	330(ra) # 31e <close>
  return r;
}
 1dc:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 814:	b6e080e7          	jalr	-1170(ra) # 37e <sbrk>
  if(p == (char*)-1)
