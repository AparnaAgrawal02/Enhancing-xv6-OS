...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fa:	d14080e7          	jalr	-748(ra) # e0a <exec>
  ...
  exit(0);
    ...
    close(rcmd->fd);
     ...
     12c:	cd2080e7          	jalr	-814(ra) # dfa <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     130:	508c                	lw	a1,32(s1)
     132:	6888                	ld	a0,16(s1)
     134:	00001097          	auipc	ra,0x1
     138:	cde080e7          	jalr	-802(ra) # e12 <open>
    ...
    if(pipe(p) < 0)
     ...
     198:	c4e080e7          	jalr	-946(ra) # de2 <pipe>
    ...
    close(p[0]);
     ...
     1bc:	c42080e7          	jalr	-958(ra) # dfa <close>
    close(p[1]);
     1c0:	fdc42503          	lw	a0,-36(s0)
     1c4:	00001097          	auipc	ra,0x1
     1c8:	c36080e7          	jalr	-970(ra) # dfa <close>
    wait(0);
     1cc:	4501                	li	a0,0
    ...
    break;
     ...
     1f8:	c06080e7          	jalr	-1018(ra) # dfa <close>
      dup(p[1]);
     1fc:	fdc42503          	lw	a0,-36(s0)
     200:	00001097          	auipc	ra,0x1
     204:	c4a080e7          	jalr	-950(ra) # e4a <dup>
      close(p[0]);
     208:	fd842503          	lw	a0,-40(s0)
     20c:	00001097          	auipc	ra,0x1
     210:	bee080e7          	jalr	-1042(ra) # dfa <close>
      close(p[1]);
     214:	fdc42503          	lw	a0,-36(s0)
     218:	00001097          	auipc	ra,0x1
     21c:	be2080e7          	jalr	-1054(ra) # dfa <close>
      runcmd(pcmd->left);
     220:	6488                	ld	a0,8(s1)
     ...
     22e:	bd0080e7          	jalr	-1072(ra) # dfa <close>
      dup(p[0]);
     232:	fd842503          	lw	a0,-40(s0)
     236:	00001097          	auipc	ra,0x1
     23a:	c14080e7          	jalr	-1004(ra) # e4a <dup>
      close(p[0]);
     23e:	fd842503          	lw	a0,-40(s0)
     242:	00001097          	auipc	ra,0x1
     246:	bb8080e7          	jalr	-1096(ra) # dfa <close>
      close(p[1]);
     24a:	fdc42503          	lw	a0,-36(s0)
     24e:	00001097          	auipc	ra,0x1
     252:	bac080e7          	jalr	-1108(ra) # dfa <close>
      runcmd(pcmd->right);
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	394080e7          	jalr	916(ra) # e12 <open>
    ...
    if(fd >= 3){
     ...
     a94:	36a080e7          	jalr	874(ra) # dfa <close>
  while(getcmd(buf, sizeof(buf)) >= 0){
     a98:	00001497          	auipc	s1,0x1
     a9c:	9e048493          	addi	s1,s1,-1568 # 1478 <buf.1142>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9d3a0a13          	addi	s4,s4,-1581 # 147b <buf.1142+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b1a:	32c080e7          	jalr	812(ra) # e42 <chdir>
     ...
     b36:	94650513          	addi	a0,a0,-1722 # 1478 <buf.1142>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c46:	1a8080e7          	jalr	424(ra) # dea <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c98:	17e080e7          	jalr	382(ra) # e12 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     ca8:	186080e7          	jalr	390(ra) # e2a <fstat>
     cac:	892a                	mv	s2,a0
  close(fd);
     cae:	8526                	mv	a0,s1
     cb0:	00000097          	auipc	ra,0x0
     cb4:	14a080e7          	jalr	330(ra) # dfa <close>
  return r;
}
     cb8:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     e98:	f5e080e7          	jalr	-162(ra) # df2 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f0:	b6e080e7          	jalr	-1170(ra) # e5a <sbrk>
  if(p == (char*)-1)
