...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      14:	88a080e7          	jalr	-1910(ra) # 589a <open>
    if(fd >= 0){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      26:	878080e7          	jalr	-1928(ra) # 589a <open>
    uint64 addr = addrs[ai];
      2a:	55fd                	li	a1,-1
    if(fd >= 0){
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      b4:	7ea080e7          	jalr	2026(ra) # 589a <open>
  if(fd < 0){
      b8:	02054663          	bltz	a0,e4 <opentest+0x4a>
  close(fd);
      bc:	00005097          	auipc	ra,0x5
      c0:	7c6080e7          	jalr	1990(ra) # 5882 <close>
  fd = open("doesnotexist", 0);
      c4:	4581                	li	a1,0
      c6:	00006517          	auipc	a0,0x6
      ca:	07a50513          	addi	a0,a0,122 # 6140 <malloc+0x4a0>
      ce:	00005097          	auipc	ra,0x5
      d2:	7cc080e7          	jalr	1996(ra) # 589a <open>
  if(fd >= 0){
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     138:	776080e7          	jalr	1910(ra) # 58aa <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	03850513          	addi	a0,a0,56 # 6178 <malloc+0x4d8>
     148:	00005097          	auipc	ra,0x5
     14c:	752080e7          	jalr	1874(ra) # 589a <open>
     150:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     152:	4611                	li	a2,4
     ...
     160:	71e080e7          	jalr	1822(ra) # 587a <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	01050513          	addi	a0,a0,16 # 6178 <malloc+0x4d8>
     170:	00005097          	auipc	ra,0x5
     174:	72a080e7          	jalr	1834(ra) # 589a <open>
     178:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     17a:	4605                	li	a2,1
     ...
     18a:	6f4080e7          	jalr	1780(ra) # 587a <write>
  if(n != -1){
     18e:	57fd                	li	a5,-1
  ...
  unlink("truncfile");
     ...
     1a0:	70e080e7          	jalr	1806(ra) # 58aa <unlink>
  close(fd1);
     1a4:	8526                	mv	a0,s1
     1a6:	00005097          	auipc	ra,0x5
     1aa:	6dc080e7          	jalr	1756(ra) # 5882 <close>
  close(fd2);
     1ae:	854a                	mv	a0,s2
     1b0:	00005097          	auipc	ra,0x5
     1b4:	6d2080e7          	jalr	1746(ra) # 5882 <close>
}
...
00000000000001e4 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     214:	68a080e7          	jalr	1674(ra) # 589a <open>
    close(fd);
     218:	00005097          	auipc	ra,0x5
     21c:	66a080e7          	jalr	1642(ra) # 5882 <close>
  for(i = 0; i < N; i++){
  ...
  for(i = 0; i < N; i++){
    ...
    unlink(name);
     ...
     24a:	664080e7          	jalr	1636(ra) # 58aa <unlink>
  for(i = 0; i < N; i++){
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     288:	626080e7          	jalr	1574(ra) # 58aa <unlink>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	5ee080e7          	jalr	1518(ra) # 589a <open>
     2b4:	892a                	mv	s2,a0
    if(fd < 0){
     ...
     2c2:	5bc080e7          	jalr	1468(ra) # 587a <write>
     2c6:	89aa                	mv	s3,a0
      if(cc != sz){
     ...
     2d6:	5a8080e7          	jalr	1448(ra) # 587a <write>
      if(cc != sz){
     2da:	04951963          	bne	a0,s1,32c <bigwrite+0xc8>
    close(fd);
     2de:	854a                	mv	a0,s2
     2e0:	00005097          	auipc	ra,0x5
     2e4:	5a2080e7          	jalr	1442(ra) # 5882 <close>
    unlink("bigwrite");
     2e8:	8556                	mv	a0,s5
     2ea:	00005097          	auipc	ra,0x5
     2ee:	5c0080e7          	jalr	1472(ra) # 58aa <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     388:	516080e7          	jalr	1302(ra) # 589a <open>
     38c:	84aa                	mv	s1,a0
    if(fd < 0){
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4ec:	3b2080e7          	jalr	946(ra) # 589a <open>
     4f0:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     52c:	352080e7          	jalr	850(ra) # 587a <write>
    if(n != 1){
     530:	4785                	li	a5,1
...
0000000000000608 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     628:	286080e7          	jalr	646(ra) # 58aa <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     63c:	262080e7          	jalr	610(ra) # 589a <open>
     640:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     642:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     698:	206080e7          	jalr	518(ra) # 589a <open>
     69c:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     6d4:	1a2080e7          	jalr	418(ra) # 5872 <read>
     6d8:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     716:	160080e7          	jalr	352(ra) # 5872 <read>
  if(n != 2){
     71a:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     72c:	182080e7          	jalr	386(ra) # 58aa <unlink>
  close(fd1);
     730:	854e                	mv	a0,s3
     732:	00005097          	auipc	ra,0x5
     736:	150080e7          	jalr	336(ra) # 5882 <close>
  close(fd2);
     73a:	8526                	mv	a0,s1
     73c:	00005097          	auipc	ra,0x5
     740:	146080e7          	jalr	326(ra) # 5882 <close>
  close(fd3);
     744:	854a                	mv	a0,s2
     746:	00005097          	auipc	ra,0x5
     74a:	13c080e7          	jalr	316(ra) # 5882 <close>
}
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     840:	05e080e7          	jalr	94(ra) # 589a <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     86a:	014080e7          	jalr	20(ra) # 587a <write>
     86e:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     87e:	000080e7          	jalr	ra # 587a <write>
     882:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8c0:	fb6080e7          	jalr	-74(ra) # 5872 <read>
  if(i != N*SZ*2){
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9ce:	ed0080e7          	jalr	-304(ra) # 589a <open>
     9d2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9d4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     9f6:	e88080e7          	jalr	-376(ra) # 587a <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     a40:	e36080e7          	jalr	-458(ra) # 5872 <read>
    if(i == 0){
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	d1e080e7          	jalr	-738(ra) # 589a <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	ce4080e7          	jalr	-796(ra) # 58aa <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	cbe080e7          	jalr	-834(ra) # 589a <open>
     be4:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be6:	460d                	li	a2,3
     ...
     bf4:	c8a080e7          	jalr	-886(ra) # 587a <write>
  close(fd1);
     bf8:	854a                	mv	a0,s2
     bfa:	00005097          	auipc	ra,0x5
     bfe:	c88080e7          	jalr	-888(ra) # 5882 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c12:	c64080e7          	jalr	-924(ra) # 5872 <read>
     c16:	4795                	li	a5,5
...
0000000000000d16 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     d54:	b4a080e7          	jalr	-1206(ra) # 589a <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	b12080e7          	jalr	-1262(ra) # 587a <write>
     d70:	4795                	li	a5,5
     d72:	10f51863          	bne	a0,a5,e82 <linktest+0x16c>
  close(fd);
     d76:	8526                	mv	a0,s1
     d78:	00005097          	auipc	ra,0x5
     d7c:	b0a080e7          	jalr	-1270(ra) # 5882 <close>
  if(link("lf1", "lf2") < 0){
     ...
     d94:	b2a080e7          	jalr	-1238(ra) # 58ba <link>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	ace080e7          	jalr	-1330(ra) # 589a <open>
     dd4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     e1e:	a90080e7          	jalr	-1392(ra) # 58aa <unlink>
  if(link("lf2", "lf1") >= 0){
     ...
     e36:	a88080e7          	jalr	-1400(ra) # 58ba <link>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e52:	a6c080e7          	jalr	-1428(ra) # 58ba <link>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff2:	8cc080e7          	jalr	-1844(ra) # 58ba <link>
     ff6:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    100c:	8a2080e7          	jalr	-1886(ra) # 58aa <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    104e:	860080e7          	jalr	-1952(ra) # 58aa <unlink>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f6:	7c8080e7          	jalr	1992(ra) # 58ba <link>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1154:	742080e7          	jalr	1858(ra) # 5892 <exec>

  pipe((int*)0xeaeb0b5b00002f5e);
    1158:	8526                	mv	a0,s1
    115a:	00004097          	auipc	ra,0x4
    115e:	710080e7          	jalr	1808(ra) # 586a <pipe>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    11a0:	6f6080e7          	jalr	1782(ra) # 5892 <exec>
  for(int i = 0; i < 50000; i++){
...
00000000000011b2 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    11dc:	6d2080e7          	jalr	1746(ra) # 58aa <unlink>
  if(ret != -1){
    11e0:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    11f2:	6ac080e7          	jalr	1708(ra) # 589a <open>
  if(fd != -1){
    11f6:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    1206:	6b8080e7          	jalr	1720(ra) # 58ba <link>
  if(ret != -1){
    120a:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    122c:	66a080e7          	jalr	1642(ra) # 5892 <exec>
  if(ret != -1){
    1230:	57fd                	li	a5,-1
  ...
  if(pid == 0){
    ...
    124a:	44a78793          	addi	a5,a5,1098 # 8690 <big.1279>
    ...
    129c:	5fa080e7          	jalr	1530(ra) # 5892 <exec>
    if(ret != -1){
    12a0:	57fd                	li	a5,-1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	4d2080e7          	jalr	1234(ra) # 589a <open>
    13d0:	00004097          	auipc	ra,0x4
    13d4:	4b2080e7          	jalr	1202(ra) # 5882 <close>
  pid = fork();
  ...
  if(pid == 0){
    ...
    1402:	49c080e7          	jalr	1180(ra) # 589a <open>
    1406:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    1414:	46a080e7          	jalr	1130(ra) # 587a <write>
      if(n != 10){
    1418:	47a9                	li	a5,10
    ...
    1424:	462080e7          	jalr	1122(ra) # 5882 <close>
      fd = open("truncfile", O_RDONLY);
    1428:	4581                	li	a1,0
    142a:	8552                	mv	a0,s4
    142c:	00004097          	auipc	ra,0x4
    1430:	46e080e7          	jalr	1134(ra) # 589a <open>
    1434:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1436:	02000613          	li	a2,32
    143a:	f9840593          	addi	a1,s0,-104
    143e:	00004097          	auipc	ra,0x4
    1442:	434080e7          	jalr	1076(ra) # 5872 <read>
      close(fd);
    1446:	8526                	mv	a0,s1
    1448:	00004097          	auipc	ra,0x4
    144c:	43a080e7          	jalr	1082(ra) # 5882 <close>
    for(int i = 0; i < 100; i++){
    ...
    14d4:	3ca080e7          	jalr	970(ra) # 589a <open>
    14d8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    14e6:	398080e7          	jalr	920(ra) # 587a <write>
    if(n != 3){
    14ea:	478d                	li	a5,3
    ...
    14f6:	390080e7          	jalr	912(ra) # 5882 <close>
  for(int i = 0; i < 150; i++){
  ...
  unlink("truncfile");
    ...
    1518:	396080e7          	jalr	918(ra) # 58aa <unlink>
  exit(xstatus);
...
0000000000001562 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1598:	316080e7          	jalr	790(ra) # 58aa <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    15b2:	2d4080e7          	jalr	724(ra) # 5882 <close>
    ...
    15c6:	2d8080e7          	jalr	728(ra) # 589a <open>
    if(fd < 0) {
    ...
    1638:	25e080e7          	jalr	606(ra) # 5892 <exec>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    169c:	202080e7          	jalr	514(ra) # 589a <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16ae:	1c8080e7          	jalr	456(ra) # 5872 <read>
    16b2:	4789                	li	a5,2
  ...
  unlink("echo-ok");
    ...
    16fc:	1b2080e7          	jalr	434(ra) # 58aa <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
...
000000000000173e <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    175e:	110080e7          	jalr	272(ra) # 586a <pipe>
  ...
  if(pid == 0){
    ...
    177e:	108080e7          	jalr	264(ra) # 5882 <close>
    total = 0;
    1782:	8a26                	mv	s4,s1
    cc = 1;
    1784:	4985                	li	s3,1
    ...
    179c:	0da080e7          	jalr	218(ra) # 5872 <read>
    ...
    17fe:	088080e7          	jalr	136(ra) # 5882 <close>
    for(n = 0; n < N; n++){
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1840:	03e080e7          	jalr	62(ra) # 587a <write>
    ...
    18d2:	fb4080e7          	jalr	-76(ra) # 5882 <close>
    wait(&xstatus);
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c54:	c4a080e7          	jalr	-950(ra) # 589a <open>
        if(fd < 0){
    1c58:	fc0543e3          	bltz	a0,1c1e <createdelete+0x94>
        close(fd);
    1c5c:	00004097          	auipc	ra,0x4
    1c60:	c26080e7          	jalr	-986(ra) # 5882 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1c88:	c26080e7          	jalr	-986(ra) # 58aa <unlink>
    ...
    1d04:	b9a080e7          	jalr	-1126(ra) # 589a <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1d1c:	b6a080e7          	jalr	-1174(ra) # 5882 <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1d7c:	b32080e7          	jalr	-1230(ra) # 58aa <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	ad6080e7          	jalr	-1322(ra) # 58aa <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e40:	a5e080e7          	jalr	-1442(ra) # 589a <open>
    1e44:	00004097          	auipc	ra,0x4
    1e48:	a3e080e7          	jalr	-1474(ra) # 5882 <close>
    1e4c:	a031                	j	1e58 <linkunlink+0xa8>
      unlink("x");
    1e4e:	8556                	mv	a0,s5
    1e50:	00004097          	auipc	ra,0x4
    1e54:	a5a080e7          	jalr	-1446(ra) # 58aa <unlink>
  for(i = 0; i < 100; i++){
    ...
    1e7a:	a44080e7          	jalr	-1468(ra) # 58ba <link>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f40:	96e080e7          	jalr	-1682(ra) # 58aa <unlink>
    1f44:	4b79                	li	s6,30
          int cc = write(fd, buf, sz);
    ...
    1f60:	93e080e7          	jalr	-1730(ra) # 589a <open>
    1f64:	89aa                	mv	s3,a0
          if(fd < 0){
    ...
    1f72:	90c080e7          	jalr	-1780(ra) # 587a <write>
          if(cc != sz){
    ...
    1f82:	904080e7          	jalr	-1788(ra) # 5882 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    1f94:	91a080e7          	jalr	-1766(ra) # 58aa <unlink>
    ...
    1fa6:	908080e7          	jalr	-1784(ra) # 58aa <unlink>
      exit(0);
    1faa:	4501                	li	a0,0
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    224e:	660080e7          	jalr	1632(ra) # 58aa <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    2280:	61e080e7          	jalr	1566(ra) # 589a <open>
  if(fd < 0){
    2284:	08054e63          	bltz	a0,2320 <bigargtest+0xea>
  close(fd);
    2288:	00003097          	auipc	ra,0x3
    228c:	5fa080e7          	jalr	1530(ra) # 5882 <close>
}
    ...
    229e:	2f678793          	addi	a5,a5,758 # 8590 <args.1868>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3e668693          	addi	a3,a3,998 # 8688 <args.1868+0xf8>
    ...
    22be:	2d658593          	addi	a1,a1,726 # 8590 <args.1868>
    ...
    22d2:	5c4080e7          	jalr	1476(ra) # 5892 <exec>
    ...
    22e6:	5b8080e7          	jalr	1464(ra) # 589a <open>
    close(fd);
    22ea:	00003097          	auipc	ra,0x3
    22ee:	598080e7          	jalr	1432(ra) # 5882 <close>
    exit(0);
    22f2:	4501                	li	a0,0
...
00000000000023c0 <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    23d0:	516080e7          	jalr	1302(ra) # 58e2 <sbrk>
  uint64 top = (uint64) sbrk(0);
    23d4:	4501                	li	a0,0
    23d6:	00003097          	auipc	ra,0x3
    23da:	50c080e7          	jalr	1292(ra) # 58e2 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    23ea:	4fc080e7          	jalr	1276(ra) # 58e2 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2406:	4a8080e7          	jalr	1192(ra) # 58aa <unlink>
  if(ret != -1){
    240a:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    241a:	484080e7          	jalr	1156(ra) # 589a <open>
  if(fd != -1){
    241e:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    242c:	492080e7          	jalr	1170(ra) # 58ba <link>
  if(ret != -1){
    2430:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    2450:	446080e7          	jalr	1094(ra) # 5892 <exec>
  if(ret != -1){
    2454:	57fd                	li	a5,-1
    ...
    2472:	474080e7          	jalr	1140(ra) # 58e2 <sbrk>
...
000000000000250c <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    251e:	3c8080e7          	jalr	968(ra) # 58e2 <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    2530:	3b6080e7          	jalr	950(ra) # 58e2 <sbrk>
    2534:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    254a:	354080e7          	jalr	852(ra) # 589a <open>
    254e:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    2564:	31a080e7          	jalr	794(ra) # 587a <write>
    2568:	862a                	mv	a2,a0
  if(n >= 0){
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    2612:	264080e7          	jalr	612(ra) # 5872 <read>
    2616:	862a                	mv	a2,a0
  if(n >= 0){
  ...
  close(fd);
    ...
    2658:	22e080e7          	jalr	558(ra) # 5882 <close>
  exit(0);
    265c:	4501                	li	a0,0
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2690:	256080e7          	jalr	598(ra) # 58e2 <sbrk>
  ...
  a = sbrk(0);
    ...
    26fa:	1ec080e7          	jalr	492(ra) # 58e2 <sbrk>
    26fe:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    2700:	4901                	li	s2,0
    *b = 1;
  ...
  for(i = 0; i < 5000; i++){
    ...
    2730:	1b6080e7          	jalr	438(ra) # 58e2 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    ...
    275a:	18c080e7          	jalr	396(ra) # 58e2 <sbrk>
  c = sbrk(1);
    275e:	4505                	li	a0,1
    2760:	00003097          	auipc	ra,0x3
    2764:	182080e7          	jalr	386(ra) # 58e2 <sbrk>
  if(c != a + 1){
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    285a:	08c080e7          	jalr	140(ra) # 58e2 <sbrk>
    285e:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2860:	757d                	lui	a0,0xfffff
    2862:	00003097          	auipc	ra,0x3
    2866:	080080e7          	jalr	128(ra) # 58e2 <sbrk>
  ...
  c = sbrk(0);
    ...
    2876:	070080e7          	jalr	112(ra) # 58e2 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    28c6:	020080e7          	jalr	32(ra) # 58e2 <sbrk>
    28ca:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    28cc:	4501                	li	a0,0
    28ce:	00003097          	auipc	ra,0x3
    28d2:	014080e7          	jalr	20(ra) # 58e2 <sbrk>
    28d6:	40a9053b          	subw	a0,s2,a0
    28da:	00003097          	auipc	ra,0x3
    28de:	008080e7          	jalr	8(ra) # 58e2 <sbrk>
  if(c != a){
...
00000000000029aa <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    29c0:	f26080e7          	jalr	-218(ra) # 58e2 <sbrk>
    29c4:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    29fa:	e84080e7          	jalr	-380(ra) # 587a <write>
    29fe:	04054663          	bltz	a0,2a4a <sbrkarg+0xa0>
  close(fd);
    2a02:	8526                	mv	a0,s1
    2a04:	00003097          	auipc	ra,0x3
    2a08:	e7e080e7          	jalr	-386(ra) # 5882 <close>
  a = sbrk(PGSIZE);
    2a0c:	6505                	lui	a0,0x1
    2a0e:	00003097          	auipc	ra,0x3
    2a12:	ed4080e7          	jalr	-300(ra) # 58e2 <sbrk>
  if(pipe((int *) a) != 0){
    2a16:	00003097          	auipc	ra,0x3
    2a1a:	e54080e7          	jalr	-428(ra) # 586a <pipe>
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a9e:	e00080e7          	jalr	-512(ra) # 589a <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2aae:	e38080e7          	jalr	-456(ra) # 58e2 <sbrk>
    2ab2:	567d                	li	a2,-1
    2ab4:	fff50593          	addi	a1,a0,-1
    2ab8:	8526                	mv	a0,s1
    2aba:	00003097          	auipc	ra,0x3
    2abe:	db8080e7          	jalr	-584(ra) # 5872 <read>
  close(fd);
    2ac2:	8526                	mv	a0,s1
    2ac4:	00003097          	auipc	ra,0x3
    2ac8:	dbe080e7          	jalr	-578(ra) # 5882 <close>
}
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b0e:	dd8080e7          	jalr	-552(ra) # 58e2 <sbrk>
    sbrk(-sz);
    2b12:	40a0053b          	negw	a0,a0
    2b16:	00003097          	auipc	ra,0x3
    2b1a:	dcc080e7          	jalr	-564(ra) # 58e2 <sbrk>
    exit(0);
    2b1e:	4501                	li	a0,0
...
0000000000002c0c <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2c20:	cc6080e7          	jalr	-826(ra) # 58e2 <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2c30:	cb6080e7          	jalr	-842(ra) # 58e2 <sbrk>
  sbrk(10);
    2c34:	4529                	li	a0,10
    2c36:	00003097          	auipc	ra,0x3
    2c3a:	cac080e7          	jalr	-852(ra) # 58e2 <sbrk>
  sbrk(-20);
    2c3e:	5531                	li	a0,-20
    2c40:	00003097          	auipc	ra,0x3
    2c44:	ca2080e7          	jalr	-862(ra) # 58e2 <sbrk>
  top = (uint64) sbrk(0);
    2c48:	4501                	li	a0,0
    2c4a:	00003097          	auipc	ra,0x3
    2c4e:	c98080e7          	jalr	-872(ra) # 58e2 <sbrk>
    2c52:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2c6e:	c30080e7          	jalr	-976(ra) # 589a <open>
    2c72:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2c74:	4605                	li	a2,1
    2c76:	85ca                	mv	a1,s2
    2c78:	00003097          	auipc	ra,0x3
    2c7c:	c02080e7          	jalr	-1022(ra) # 587a <write>
  close(fd);
    2c80:	854e                	mv	a0,s3
    2c82:	00003097          	auipc	ra,0x3
    2c86:	c00080e7          	jalr	-1024(ra) # 5882 <close>
  fd = open(p, O_RDWR);
    2c8a:	4589                	li	a1,2
    2c8c:	854a                	mv	a0,s2
    2c8e:	00003097          	auipc	ra,0x3
    2c92:	c0c080e7          	jalr	-1012(ra) # 589a <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2ca2:	bd4080e7          	jalr	-1068(ra) # 5872 <read>
  if(p[0] != 'x')
    ...
    2cce:	c18080e7          	jalr	-1000(ra) # 58e2 <sbrk>
...
0000000000002cde <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2cf0:	bf6080e7          	jalr	-1034(ra) # 58e2 <sbrk>
  volatile char *top = sbrk(0);
    2cf4:	4501                	li	a0,0
    2cf6:	00003097          	auipc	ra,0x3
    2cfa:	bec080e7          	jalr	-1044(ra) # 58e2 <sbrk>
  *(top-1) = *(top-1) + 1;
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d76:	b70080e7          	jalr	-1168(ra) # 58e2 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2d92:	b54080e7          	jalr	-1196(ra) # 58e2 <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2da2:	ae4080e7          	jalr	-1308(ra) # 5882 <close>
      char *args[] = { "echo", "x", 0 };
    ...
    2dca:	acc080e7          	jalr	-1332(ra) # 5892 <exec>
      exit(0);
    2dce:	4501                	li	a0,0
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2df0:	ad6080e7          	jalr	-1322(ra) # 58c2 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e02:	ac4080e7          	jalr	-1340(ra) # 58c2 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e64:	a62080e7          	jalr	-1438(ra) # 58c2 <mkdir>
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f94:	932080e7          	jalr	-1742(ra) # 58c2 <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa8:	926080e7          	jalr	-1754(ra) # 58ca <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fbc:	8f2080e7          	jalr	-1806(ra) # 58aa <unlink>
  ...
  if(chdir("/") < 0){
    ...
    2fd0:	8fe080e7          	jalr	-1794(ra) # 58ca <chdir>
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3078:	84e080e7          	jalr	-1970(ra) # 58c2 <mkdir>
    ...
    308c:	842080e7          	jalr	-1982(ra) # 58ca <chdir>
    ...
    30a0:	80e080e7          	jalr	-2034(ra) # 58aa <unlink>
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3152:	774080e7          	jalr	1908(ra) # 58c2 <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    3166:	768080e7          	jalr	1896(ra) # 58ca <chdir>
  ...
  if(chdir("..") < 0){
    ...
    317a:	754080e7          	jalr	1876(ra) # 58ca <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    318e:	720080e7          	jalr	1824(ra) # 58aa <unlink>
...
0000000000003210 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3252:	64c080e7          	jalr	1612(ra) # 589a <open>
    3256:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3298:	62e080e7          	jalr	1582(ra) # 58c2 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32b0:	5ee080e7          	jalr	1518(ra) # 589a <open>
    32b4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32fc:	57a080e7          	jalr	1402(ra) # 5872 <read>
  if(cc != 2 || buf[0] != 'f'){
    3300:	4789                	li	a5,2
  ...
  close(fd);
    ...
    331c:	56a080e7          	jalr	1386(ra) # 5882 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3334:	58a080e7          	jalr	1418(ra) # 58ba <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3348:	566080e7          	jalr	1382(ra) # 58aa <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    335e:	540080e7          	jalr	1344(ra) # 589a <open>
  ...
  if(chdir("dd") != 0){
    ...
    3372:	55c080e7          	jalr	1372(ra) # 58ca <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3386:	548080e7          	jalr	1352(ra) # 58ca <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    339a:	534080e7          	jalr	1332(ra) # 58ca <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    33ae:	520080e7          	jalr	1312(ra) # 58ca <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33c4:	4da080e7          	jalr	1242(ra) # 589a <open>
    33c8:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3416:	488080e7          	jalr	1160(ra) # 589a <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    342e:	470080e7          	jalr	1136(ra) # 589a <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3446:	458080e7          	jalr	1112(ra) # 589a <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    345c:	442080e7          	jalr	1090(ra) # 589a <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3472:	42c080e7          	jalr	1068(ra) # 589a <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    348e:	430080e7          	jalr	1072(ra) # 58ba <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34aa:	414080e7          	jalr	1044(ra) # 58ba <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34c6:	3f8080e7          	jalr	1016(ra) # 58ba <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34da:	3ec080e7          	jalr	1004(ra) # 58c2 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34ee:	3d8080e7          	jalr	984(ra) # 58c2 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3502:	3c4080e7          	jalr	964(ra) # 58c2 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3516:	398080e7          	jalr	920(ra) # 58aa <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    352a:	384080e7          	jalr	900(ra) # 58aa <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    353e:	390080e7          	jalr	912(ra) # 58ca <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3552:	37c080e7          	jalr	892(ra) # 58ca <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3566:	348080e7          	jalr	840(ra) # 58aa <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    357a:	334080e7          	jalr	820(ra) # 58aa <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    358e:	320080e7          	jalr	800(ra) # 58aa <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35a2:	30c080e7          	jalr	780(ra) # 58aa <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    35b6:	2f8080e7          	jalr	760(ra) # 58aa <unlink>
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39ee:	ed8080e7          	jalr	-296(ra) # 58c2 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    3a00:	ece080e7          	jalr	-306(ra) # 58ca <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3a12:	e9c080e7          	jalr	-356(ra) # 58aa <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3a24:	e8a080e7          	jalr	-374(ra) # 58aa <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3a36:	e98080e7          	jalr	-360(ra) # 58ca <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a48:	e66080e7          	jalr	-410(ra) # 58aa <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a5a:	e54080e7          	jalr	-428(ra) # 58aa <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3a6c:	e42080e7          	jalr	-446(ra) # 58aa <unlink>
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    3baa:	cf4080e7          	jalr	-780(ra) # 589a <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bc2:	cdc080e7          	jalr	-804(ra) # 589a <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bd6:	cf0080e7          	jalr	-784(ra) # 58c2 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bea:	cc4080e7          	jalr	-828(ra) # 58aa <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c06:	cb8080e7          	jalr	-840(ra) # 58ba <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c1a:	c94080e7          	jalr	-876(ra) # 58aa <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    3c30:	c6e080e7          	jalr	-914(ra) # 589a <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    3c46:	c58080e7          	jalr	-936(ra) # 589a <open>
    3c4a:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3c4c:	4605                	li	a2,1
    ...
    3c5a:	c24080e7          	jalr	-988(ra) # 587a <write>
    3c5e:	10a04b63          	bgtz	a0,3d74 <dirfile+0x218>
  close(fd);
    3c62:	8526                	mv	a0,s1
    3c64:	00002097          	auipc	ra,0x2
    3c68:	c1e080e7          	jalr	-994(ra) # 5882 <close>
}
...
0000000000003d90 <iref>:
{
    ...
    3e08:	a7e080e7          	jalr	-1410(ra) # 5882 <close>
    3e0c:	a889                	j	3e5e <iref+0xce>
    unlink("xx");
    3e0e:	854e                	mv	a0,s3
    3e10:	00002097          	auipc	ra,0x2
    3e14:	a9a080e7          	jalr	-1382(ra) # 58aa <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e68:	a36080e7          	jalr	-1482(ra) # 589a <open>
    if(fd >= 0)
    3e6c:	fa0541e3          	bltz	a0,3e0e <iref+0x7e>
      close(fd);
    3e70:	00002097          	auipc	ra,0x2
    3e74:	a12080e7          	jalr	-1518(ra) # 5882 <close>
    ...
    3e94:	a3a080e7          	jalr	-1478(ra) # 58ca <chdir>
    unlink("irefd");
    3e98:	854a                	mv	a0,s2
    3e9a:	00002097          	auipc	ra,0x2
    3e9e:	a10080e7          	jalr	-1520(ra) # 58aa <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    3eb2:	a1c080e7          	jalr	-1508(ra) # 58ca <chdir>
}
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ee2:	9e4080e7          	jalr	-1564(ra) # 58c2 <mkdir>
  ...
  if(pid == 0){
    ...
    3f06:	998080e7          	jalr	-1640(ra) # 589a <open>
    if(fd >= 0){
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fd4:	8da080e7          	jalr	-1830(ra) # 58aa <unlink>
  int pid = fork();
  ...
  sleep(20); // two seconds
    ...
    3fec:	902080e7          	jalr	-1790(ra) # 58ea <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4000:	89e080e7          	jalr	-1890(ra) # 589a <open>
    4004:	00002097          	auipc	ra,0x2
    4008:	87e080e7          	jalr	-1922(ra) # 5882 <close>
  wait(0);
    400c:	4501                	li	a0,0
  ...
  sleep(10); // one second
    ...
    401c:	8d2080e7          	jalr	-1838(ra) # 58ea <sleep>
}
    ...
    4056:	848080e7          	jalr	-1976(ra) # 589a <open>
      if(fd >= 0){
    ...
    4074:	82a080e7          	jalr	-2006(ra) # 589a <open>
    4078:	00002097          	auipc	ra,0x2
    407c:	80a080e7          	jalr	-2038(ra) # 5882 <close>
...
000000000000408c <killstatus>:
{
    ...
    40ba:	834080e7          	jalr	-1996(ra) # 58ea <sleep>
    kill(pid1);
    40be:	8526                	mv	a0,s1
    40c0:	00001097          	auipc	ra,0x1
    40c4:	7ca080e7          	jalr	1994(ra) # 588a <kill>
    wait(&xst);
  ...
  exit(0);
    ...
    410c:	7d2080e7          	jalr	2002(ra) # 58da <getpid>
      while(1) {
...
000000000000412e <preempt>:
{
  ...
  pipe(pfds);
    ...
    41a4:	6ca080e7          	jalr	1738(ra) # 586a <pipe>
  pid3 = fork();
  ...
  if(pid3 == 0){
    ...
    41c0:	6c6080e7          	jalr	1734(ra) # 5882 <close>
  ...
  close(pfds[1]);
    ...
    4226:	660080e7          	jalr	1632(ra) # 5882 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    423c:	63a080e7          	jalr	1594(ra) # 5872 <read>
    4240:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    4270:	616080e7          	jalr	1558(ra) # 5882 <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    428a:	604080e7          	jalr	1540(ra) # 588a <kill>
  kill(pid2);
    428e:	854e                	mv	a0,s3
    4290:	00001097          	auipc	ra,0x1
    4294:	5fa080e7          	jalr	1530(ra) # 588a <kill>
  kill(pid3);
    4298:	854a                	mv	a0,s2
    429a:	00001097          	auipc	ra,0x1
    429e:	5f0080e7          	jalr	1520(ra) # 588a <kill>
  printf("wait... ");
...
00000000000042d2 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    42e8:	5f6080e7          	jalr	1526(ra) # 58da <getpid>
    42ec:	8a2a                	mv	s4,a0
  ...
  exit(0);
    ...
    4374:	51a080e7          	jalr	1306(ra) # 588a <kill>
        exit(1);
    4378:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    439e:	4d0080e7          	jalr	1232(ra) # 586a <pipe>
    ...
    43fa:	484080e7          	jalr	1156(ra) # 587a <write>
      for(;;) sleep(1000);
    43fe:	3e800513          	li	a0,1000
    4402:	00001097          	auipc	ra,0x1
    4406:	4e8080e7          	jalr	1256(ra) # 58ea <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    4458:	436080e7          	jalr	1078(ra) # 588a <kill>
    wait(0);
    445c:	4501                	li	a0,0
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44ea:	3fc080e7          	jalr	1020(ra) # 58e2 <sbrk>
    44ee:	89aa                	mv	s3,a0
    sbrk(10*BIG);
    44f0:	3e800537          	lui	a0,0x3e800
    44f4:	00001097          	auipc	ra,0x1
    44f8:	3ee080e7          	jalr	1006(ra) # 58e2 <sbrk>
...
00000000000045e0 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4604:	2aa080e7          	jalr	682(ra) # 58aa <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4618:	286080e7          	jalr	646(ra) # 589a <open>
  if(fd < 0){
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4654:	22a080e7          	jalr	554(ra) # 587a <write>
    4658:	47a9                	li	a5,10
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4702:	174080e7          	jalr	372(ra) # 5872 <read>
...
0000000000004798 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    47fc:	0b2080e7          	jalr	178(ra) # 58aa <unlink>
    pid = fork();
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4878:	026080e7          	jalr	38(ra) # 589a <open>
    487c:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    48b0:	fce080e7          	jalr	-50(ra) # 587a <write>
    48b4:	85aa                	mv	a1,a0
    ...
    4934:	f42080e7          	jalr	-190(ra) # 5872 <read>
    ...
    4964:	f22080e7          	jalr	-222(ra) # 5882 <close>
    if(total != N*SZ){
    4968:	03a91963          	bne	s2,s10,499a <fourfiles+0x202>
    unlink(fname);
    496c:	8562                	mv	a0,s8
    496e:	00001097          	auipc	ra,0x1
    4972:	f3c080e7          	jalr	-196(ra) # 58aa <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    498a:	f14080e7          	jalr	-236(ra) # 589a <open>
    498e:	89aa                	mv	s3,a0
    total = 0;
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a16:	ea8080e7          	jalr	-344(ra) # 58ba <link>
    if(pid == 0) {
    ...
    4a34:	e6a080e7          	jalr	-406(ra) # 589a <open>
      if(fd < 0){
    ...
    4a6a:	e54080e7          	jalr	-428(ra) # 58ba <link>
      exit(0);
    4a6e:	4501                	li	a0,0
  ...
  fd = open(".", 0);
    ...
    4aa2:	dfc080e7          	jalr	-516(ra) # 589a <open>
    4aa6:	892a                	mv	s2,a0
  n = 0;
    4aa8:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4aee:	d88080e7          	jalr	-632(ra) # 5872 <read>
  ...
  close(fd);
    ...
    4b4c:	d3a080e7          	jalr	-710(ra) # 5882 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    4ba4:	cfa080e7          	jalr	-774(ra) # 589a <open>
    4ba8:	00001097          	auipc	ra,0x1
    4bac:	cda080e7          	jalr	-806(ra) # 5882 <close>
      close(open(file, 0));
    4bb0:	4581                	li	a1,0
    4bb2:	fa840513          	addi	a0,s0,-88
    4bb6:	00001097          	auipc	ra,0x1
    4bba:	ce4080e7          	jalr	-796(ra) # 589a <open>
    4bbe:	00001097          	auipc	ra,0x1
    4bc2:	cc4080e7          	jalr	-828(ra) # 5882 <close>
      close(open(file, 0));
    4bc6:	4581                	li	a1,0
    4bc8:	fa840513          	addi	a0,s0,-88
    4bcc:	00001097          	auipc	ra,0x1
    4bd0:	cce080e7          	jalr	-818(ra) # 589a <open>
    4bd4:	00001097          	auipc	ra,0x1
    4bd8:	cae080e7          	jalr	-850(ra) # 5882 <close>
      close(open(file, 0));
    4bdc:	4581                	li	a1,0
    4bde:	fa840513          	addi	a0,s0,-88
    4be2:	00001097          	auipc	ra,0x1
    4be6:	cb8080e7          	jalr	-840(ra) # 589a <open>
    4bea:	00001097          	auipc	ra,0x1
    4bee:	c98080e7          	jalr	-872(ra) # 5882 <close>
      close(open(file, 0));
    4bf2:	4581                	li	a1,0
    4bf4:	fa840513          	addi	a0,s0,-88
    4bf8:	00001097          	auipc	ra,0x1
    4bfc:	ca2080e7          	jalr	-862(ra) # 589a <open>
    4c00:	00001097          	auipc	ra,0x1
    4c04:	c82080e7          	jalr	-894(ra) # 5882 <close>
      close(open(file, 0));
    4c08:	4581                	li	a1,0
    4c0a:	fa840513          	addi	a0,s0,-88
    4c0e:	00001097          	auipc	ra,0x1
    4c12:	c8c080e7          	jalr	-884(ra) # 589a <open>
    4c16:	00001097          	auipc	ra,0x1
    4c1a:	c6c080e7          	jalr	-916(ra) # 5882 <close>
    if(pid == 0)
  ...
  for(i = 0; i < N; i++){
    ...
    4cb2:	bd4080e7          	jalr	-1068(ra) # 5882 <close>
    if(pid == 0) {
    4cb6:	bb65                	j	4a6e <concreate+0x9a>
      close(fd);
    4cb8:	00001097          	auipc	ra,0x1
    4cbc:	bca080e7          	jalr	-1078(ra) # 5882 <close>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    4cea:	bc4080e7          	jalr	-1084(ra) # 58aa <unlink>
    pid = fork();
    ...
    4d0e:	b90080e7          	jalr	-1136(ra) # 589a <open>
      if(fd < 0){
...
0000000000004d2e <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4d4e:	b60080e7          	jalr	-1184(ra) # 58aa <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    4d62:	b3c080e7          	jalr	-1220(ra) # 589a <open>
    4d66:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4d68:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    4d94:	aea080e7          	jalr	-1302(ra) # 587a <write>
  ...
  if(fd < 0){
    ...
    4de0:	a96080e7          	jalr	-1386(ra) # 5872 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    4ec2:	9c4080e7          	jalr	-1596(ra) # 5882 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    4edc:	9d2080e7          	jalr	-1582(ra) # 58aa <unlink>
}
...
0000000000004f0e <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fb8:	8e6080e7          	jalr	-1818(ra) # 589a <open>
    4fbc:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    5032:	87c080e7          	jalr	-1924(ra) # 58aa <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    507c:	802080e7          	jalr	-2046(ra) # 587a <write>
      if(cc < BSIZE)
    ...
    50a2:	7e4080e7          	jalr	2020(ra) # 5882 <close>
    if(total == 0)
...
00000000000050ae <badwrite>:
{
  ...
  unlink("junk");
    ...
    50ca:	7e4080e7          	jalr	2020(ra) # 58aa <unlink>
    ...
    50ea:	7b4080e7          	jalr	1972(ra) # 589a <open>
    50ee:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    50fc:	782080e7          	jalr	1922(ra) # 587a <write>
    close(fd);
    5100:	8526                	mv	a0,s1
    5102:	00000097          	auipc	ra,0x0
    5106:	780080e7          	jalr	1920(ra) # 5882 <close>
    unlink("junk");
    510a:	854e                	mv	a0,s3
    510c:	00000097          	auipc	ra,0x0
    5110:	79e080e7          	jalr	1950(ra) # 58aa <unlink>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    512a:	774080e7          	jalr	1908(ra) # 589a <open>
    512e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5142:	73c080e7          	jalr	1852(ra) # 587a <write>
    5146:	4785                	li	a5,1
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    51d4:	69a080e7          	jalr	1690(ra) # 586a <pipe>
  ...
  if(pid == 0){
    ...
    51f2:	694080e7          	jalr	1684(ra) # 5882 <close>
    ...
    5208:	6de080e7          	jalr	1758(ra) # 58e2 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    5224:	65a080e7          	jalr	1626(ra) # 587a <write>
    5228:	4785                	li	a5,1
  ...
  close(fds[1]);
    ...
    528e:	5f8080e7          	jalr	1528(ra) # 5882 <close>
  ...
  while(1){
    ...
    52a2:	5d4080e7          	jalr	1492(ra) # 5872 <read>
    if(cc < 0){
  ...
  close(fds[0]);
    ...
    52d2:	5b4080e7          	jalr	1460(ra) # 5882 <close>
  wait((int*)0);
    52d6:	4501                	li	a0,0
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    56ce:	1a8080e7          	jalr	424(ra) # 5872 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5720:	17e080e7          	jalr	382(ra) # 589a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5730:	186080e7          	jalr	390(ra) # 58b2 <fstat>
    5734:	892a                	mv	s2,a0
  close(fd);
    5736:	8526                	mv	a0,s1
    5738:	00000097          	auipc	ra,0x0
    573c:	14a080e7          	jalr	330(ra) # 5882 <close>
  return r;
}
    5740:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5920:	f5e080e7          	jalr	-162(ra) # 587a <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d78:	b6e080e7          	jalr	-1170(ra) # 58e2 <sbrk>
  if(p == (char*)-1)
