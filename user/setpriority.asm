...
{ 
  ...
  4c:	354080e7          	jalr	852(ra) # 39c <set_priority>
    if(oldsp==-1){
  50:	57fd                	li	a5,-1
  52:	00f50763          	beq	a0,a5,60 <main+0x60>
        fprintf(2, "set_priority: did not find pid %s\n", argv[1]);
    }
    exit(0); 
  56:	4501                	li	a0,0
  58:	00000097          	auipc	ra,0x0
  5c:	294080e7          	jalr	660(ra) # 2ec <exit>
        fprintf(2, "set_priority: did not find pid %s\n", argv[1]);
  60:	6490                	ld	a2,8(s1)
  62:	00000597          	auipc	a1,0x0
  66:	7d658593          	addi	a1,a1,2006 # 838 <malloc+0xfe>
  6a:	4509                	li	a0,2
  6c:	00000097          	auipc	ra,0x0
  70:	5e2080e7          	jalr	1506(ra) # 64e <fprintf>
  74:	b7cd                	j	56 <main+0x56>
...
gets(char *buf, int max)
{
 ...
 168:	1a8080e7          	jalr	424(ra) # 30c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ba:	17e080e7          	jalr	382(ra) # 334 <open>
  if(fd < 0)
 ...
 1ca:	186080e7          	jalr	390(ra) # 34c <fstat>
 1ce:	892a                	mv	s2,a0
  close(fd);
 1d0:	8526                	mv	a0,s1
 1d2:	00000097          	auipc	ra,0x0
 1d6:	14a080e7          	jalr	330(ra) # 31c <close>
  return r;
}
 1da:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ec:	48050513          	addi	a0,a0,1152 # 868 <digits>
 3f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b8:	3b4b8b93          	addi	s7,s7,948 # 868 <digits>
 ...
 5f8:	26c90913          	addi	s2,s2,620 # 860 <malloc+0x126>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c0:	1c47b783          	ld	a5,452(a5) # 880 <freep>
 ...
 6ee:	00e6ea63          	bltu	a3,a4,702 <free+0x50>
{
 ...
 730:	14f73a23          	sd	a5,340(a4) # 880 <freep>
}
 734:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 762:	12253503          	ld	a0,290(a0) # 880 <freep>
 ...
 78a:	0fa90913          	addi	s2,s2,250 # 880 <freep>
  if(p == (char*)-1)
 78e:	5afd                	li	s5,-1
 790:	a88d                	j	802 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 792:	00000797          	auipc	a5,0x0
 796:	0f678793          	addi	a5,a5,246 # 888 <base>
 79a:	00000717          	auipc	a4,0x0
 79e:	0ef73323          	sd	a5,230(a4) # 880 <freep>
 7a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c4:	0ca73023          	sd	a0,192(a4) # 880 <freep>
      return (void*)(p + 1);
